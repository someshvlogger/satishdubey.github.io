...
$("#img_file_input").change(function () {
    ...
    if (file) {
        ...
        $.ajax({
            method: 'POST',
            url: base_url + "file_controller/upload_image_file",
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
$(document).on('click', '.btn-delete-additional-image-database', function () {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "image_controller/delete_post_additional_image",
        data: data,
        success: function (response) {
        }
    });
...
$("#ckimg_file_input").change(function () {
    ...
    if (file) {
        ...
        $.ajax({
            method: 'POST',
            url: base_url + "file_controller/upload_ckimage_file",
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
function delete_post_main_image(post_id,table,column) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "image_controller/delete_post_main_image",
        data: data,
        success: function (response) {
